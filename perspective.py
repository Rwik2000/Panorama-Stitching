...
def Bonus_perspective_warping(img1, img2, img3):
    ...
    output_image = o 
    output_name = "output_homography_lpb.png"
    cv2.imwrite(output_name, output_image)
...
def Cylindrical_warping(img1, img2, img3):
    ...
    output_name ="output_cylindrical.png"
    cv2.imwrite(output_name, output_image)
...
input_image1 = cv2.imread("Dataset/I2/2_1.JPG", 0)
input_image2 = cv2.imread("Dataset/I2/2_2.JPG", 0)
input_image3 = cv2.imread("Dataset/I2/2_3.JPG", 0) 
...
# Call the function
function_launch(input_image1, input_image2, input_image3)